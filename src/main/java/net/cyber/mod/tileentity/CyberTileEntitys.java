...
public class CyberTileEntitys {
    ...
    public static final RegistryObject<TileEntityType<TileEntitySurgery>> SR = TILES.register("surgeon", () -> registerTiles(TileEntitySurgery::new, CyberBlocks.SURGEON.get()));
