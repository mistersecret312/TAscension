...
public class CyberConfigs {
    ...
    public static final CyberConfigs.Server SERVER;
    ...
    static {
        ...
        final Pair<CyberConfigs.Server, ForgeConfigSpec> specServerPair = new ForgeConfigSpec.Builder().configure(CyberConfigs.Server::new);
        SERVER = specServerPair.getLeft();
        SERVER_SPEC = specServerPair.getRight();
    }

    public static class Server {
        public ForgeConfigSpec.ConfigValue<Integer> StattenheimRecipe;
